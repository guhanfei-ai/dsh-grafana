...
export const ENDPOINT_SCOPES = [
  ...
  // Prometheus 兼容规则接口读的是规则评估状态，权限是规则本体的 alert.rule:read
  // （Grafana 文档：GET /api/prometheus/grafana/api/v1/rules）。
  ['/api/prometheus/grafana/api/v1/rules', 'GET', 'alert.rule:read'],
  ['/api/health', 'GET', null],
]
